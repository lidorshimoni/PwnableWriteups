...
void dealer() //Function to play for dealer AI
{
     ...
     if(dealer_total<17)
     {
      ...
      if(random_number<=10) //If random number generated is 10 or less, keep that value
      {
         d=random_number;
          
      }
      
      if(random_number>11) //If random number generated is more than 11, change value to 10
      {
         d=10;
      }
      
      if(random_number==11) //If random number is 11(Ace), change value to 11 or 1 depending on dealer total
      {
         if(dealer_total<=10    )
         {
             d=11;
